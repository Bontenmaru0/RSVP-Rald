...
import 'teaser_video_cache_web.dart';
...
class _TeaserVideoCardState extends State<TeaserVideoCard> {
  ...
  void initState() {
    super.initState();
    final session = TeaserVideoCache.sessionFor(widget.assetPath);
    _session = session;
        ...
        child: GestureDetector(
          ...
          child: Stack(
            ...
            children: [
              ...
              if (_errorText == null && session != null)
                Positioned.fill(child: session.buildSurface()),
              Positioned.fill(
                child: DecoratedBox(
